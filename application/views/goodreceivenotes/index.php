<div class="white-background">
    <div class="minimum-height">
        <div class="bs-component">
            <a href="<?php echo site_url('goodreceivenotes/create'); ?>" class="btn btn-lg btn-secondary"
               data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Click to add a new GRN">+ Add
                New</a>
        </div>
        <hr>
        <h2>Good Received Notes</h2>
        <div class="table-responsive">
            <table id="GRNDataTable" class="table table-hover">
                <?php $count = 1; ?>
                <thead>
                <tr>
                    <th scope="col">#</th>
                ...
                <?php foreach ($goodreceivenotes as $goodreceivenote) : ?>
                    <tr>
                        ...
                        <td><?php echo $goodreceivenote['stock_qty']; ?></td>
