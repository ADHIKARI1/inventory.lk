<div class="white-background">
    <div class="minimum-height">
        ...
        <div class="table-responsive">
            <table id="UserPermissionDataTable" class="table table-hover">
                <?php $count = 1; ?>
                <thead>
                <tr>
                    <th scope="col">#</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bs-component">
                                <a href="<?php echo site_url('/userpermissions/' . $user['useraccounts_table_id']); ?>"
                                   class="btn btn-primary btn-block" data-toggle="tooltip" data-placement="bottom"
                                   title="" data-original-title="Click to view this user permissions">View</a>
                            </div>
                        </td>
                    </tr>
                    <?php $count++; ?>
