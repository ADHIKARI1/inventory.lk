...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'shinnippon.png')) {
		$tcpdf_header_logo = 'shinnippon.png';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', "SHIN NIPPON LANKA (PRIVATE) LIMITED");
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "309/1, Colombo Road, Welisara, Sri Lanka.\nTel  : +94-11-200-5300 / Fax : +94-11-223-6599\nEmail : shinnippon@snklanka.com / Web : www.snklanka.com");
}
